                ...
                <div class="forum-item">
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <a href="forum_post.html" class="forum-item-title">Admin Discussion</a>
                            <div class="forum-sub-title">This forum is for private, admin member only discussions, usually pertaining to the community itself. </div>
                        </div>
                        <div class="col-md-1 forum-info">
                            <span class="views-number">
                                1450
